...
class UserController extends Controller
{
    ...
    public function index()
    {
        ...
        return view('admin_master.user_admin.user_list',compact('user', 'total_user'));
    }
    ...
    {
        return view('admin_master.user_admin.user_list');
    }
    ...
    return view('admin_master.user_admin.user_list', compact('user', 'total_user'))->with('status', 'User berhasil dihapus');
}
}