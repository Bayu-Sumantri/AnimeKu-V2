...
<div class="container-fluid pt-4 px-4">
    ...
    <div class="bg-secondary rounded h-100 p-4">
        ...
        <div class="row">
        	@foreach ($animeku as $row)
            <div class="col-md-4"> <!-- Tambahkan class "col-md-4" untuk mengatur lebar card -->
                <div class="card">
                    <img class="img-wrap" src="{{ \Illuminate\Support\Facades\Storage::url($row->Gambar_anime) }}" alt="Image">
                    <a href="#">{{ $row->judul }}</a>
                    <p class="text" data-config='{ "type": "text", "element": "div", "limit": 80, "more": "show more ↓", "less": "show less ↑"}'>
                        {{ $row->Deskripsi_anime }}
                    </p>
