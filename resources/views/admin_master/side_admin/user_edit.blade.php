...
<div class="container-fluid pt-4 px-4">
	...
	@endif
	<form action="{{ route('Poto.update', $user->id) }}" method="post" enctype="multipart/form-data">
		@method('patch')
		@csrf
        ...
        <div class="section">
        	...
        	<p style="font-size: 14px; font-family: 'Figtree', sans-serif;">Update your Profile Picture Here.</p>
        </div>


        @if ($user->Profile)
        <img class="user" src="{{ \Illuminate\Support\Facades\Storage::url($user->Profile) }}" alt="">
        @else
        <img class="user" src="{{ asset("/admin/img/user.jpg") }}" alt="">
        @endif

        <div class="container" style="margin-top: 15px;">
        	<div class="mb-3">
        		<label for="formFile" class="form-label">Profile Picture ( {{ old('name', $user->name) }} )</label>
